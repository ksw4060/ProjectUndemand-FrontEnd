...
function Carousels() {
    ...
    return (
        <section className="carousels">
            <ul id="carousels-slide-ul" ref={slideUlRef} style={{ marginLeft: marginLeft + "px" }}>
                <li id="carousels-slide1" className={currentSlideIndex === 0 || currentSlideIndex === 1 ? "side-img" : "current-img"}></li>
                <li id="carousels-slide2" className={currentSlideIndex === 1 || currentSlideIndex === 2 ? "side-img" : "current-img"}></li>
                <li id="carousels-slide3" className={currentSlideIndex === 2 || currentSlideIndex === 0 ? "side-img" : "current-img"}></li>
            </ul>
